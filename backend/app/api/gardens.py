...
def generate_recommendations(
    ...
    goal_input = GardenGoalInput(
        ...
        planting_style=payload.planting_style,
        using_raised_beds=payload.using_raised_beds,
        raised_beds=payload.raised_beds,
        start_preference=payload.start_preference,
        can_start_seeds_indoors=payload.can_start_seeds_indoors,
        prefers_buying_starts=payload.prefers_buying_starts,
        direct_sow_preference=payload.direct_sow_preference,
